<div class="clients p-2 rounded-lg h-[80vh] overflow-y-auto overflow-x-visible w-full">
    <div class="label flex flex-col center mb-4">
        <label class="w-full relative z-20">
            <input type="text" wire:model.live="search" class="w-full p-2 rounded-lg border border-gray-200" placeholder="Search taskgiver...">
        ...
        @if($clients->isEmpty())
            <div class="center w-full">
                <div class="text-gray-500 h-full mt-16 text-center">
                    ...
                    <p class="text-lg">No taskmaster found</p>
                    <span class="text-xs text-gray-500">Try typing a taskmaster name or email</span>
                </div>
            </div>
        @else
